...
set(FFT_VALUES KISS FFTW3 MKL HEFFTE)
set_property(CACHE FFT PROPERTY STRINGS ${FFT_VALUES})
validate_option(FFT FFT_VALUES)
string(TOUPPER ${FFT} FFT)

if(FFT STREQUAL "FFTW3" OR FFT STREQUAL "HEFFTE")
  ...
  if (FFT STREQUAL "HEFFTE")
    if (Kokkos_ENABLE_CUDA)
      find_package(Heffte 2.0.0 REQUIRED FFTW CUDA)
      target_compile_definitions(lammps PRIVATE -DFFT_HEFFTE_CUDA)
    else()
      find_package(Heffte 2.0.0 REQUIRED FFTW)
    endif()
    target_compile_definitions(lammps PRIVATE -DFFT_HEFFTE)
